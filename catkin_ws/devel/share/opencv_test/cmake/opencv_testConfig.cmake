...
if("TRUE" STREQUAL "TRUE")
  set(opencv_test_SOURCE_PREFIX /home/jetson/catkin_ws/src/sea-me-hackathon-2024/opencv_test)
  set(opencv_test_DEVEL_PREFIX /home/jetson/catkin_ws/devel)
  ...
  set(opencv_test_INSTALL_PREFIX /home/jetson/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetson/catkin_ws/src/sea-me-hackathon-2024/opencv_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT opencv_test_NUM_DUMMY_TARGETS)
      set(opencv_test_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::opencv_test::wrapped-linker-option${opencv_test_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR opencv_test_NUM_DUMMY_TARGETS "${opencv_test_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::opencv_test::wrapped-linker-option${opencv_test_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND opencv_test_LIBRARIES "${interface_target_name}")
